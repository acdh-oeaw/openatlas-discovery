...
import { ChevronLeftIcon, ChevronRightIcon, FunnelIcon, SplineIcon } from "lucide-vue-next";
...
<template>
	...
	<div v-if="props.isMobile" class="p-2 text-sm">
		<Popover>
			...
			<PopoverContent side="top" class="mr-2 max-h-64 w-fit space-y-2 overflow-y-auto p-2">
				<div>
					<aside
						class="m-2 flex gap-2 overflow-x-auto rounded-r-md border-2 border-transparent bg-card p-2 text-sm shadow-md dark:bg-primary-foreground"
					>
